...
<body>
  ...
  <main>
    ...
    <div class="a-title">
      <div class="container">
        <div class="row">
          ...
          <div class="col-6">
            <h2>Subarna Bhandari&NonBreakingSpace;<i class="fa-solid fa-circle-check"></i></h2>
          </div>
          <div class="col-6 mb-hide" style="text-align: end;">
            <a href="#">Overview</a>
            <a clsss="behance" href="/link.html">Quick Link</a>
          </div>
    ...
    <div class="ahome d-nav">
      <div class="container acontainer row">
        <div class="ahome-col-1 col">
          <img src="./image/SubarnaBhandari.webp" />
        </div>
        <div class="ahome-col-2 col">

          <p>Hello!<br>Thanks for stopping by!<br>
            I’m Subarna, a web, graphic, and UI/UX designer in Kathmandu, Nepal. I help business owners and
            entrepreneurs
            create their brand identities, have an online presence, and turn their businesses into the next best thing
            in
            the market! Design for me more than just digital applications. I am a painter, a crafter, a photographer,
            and
            love decorating spaces. It wasn’t a feasible business plan but it was a creative outlet for me and I loved
            it!
